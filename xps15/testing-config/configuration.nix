...
# Experimental System Configuration.  Use at your own risk!
...

{
  ...
  networking.usePredictableInterfaceNames = false; # use this to get legacy "eth0" type interface names
  ...
  # NOTE: This needs work as the only way that works thus far is to allow root login
